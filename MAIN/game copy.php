...
<aside class="game-hero">
    <p id="game-description"><?php echo $juego[0]['descripcion']; ?></p>
    <p id="game-developer">Desarrollador: <?php echo $juego[0]['desarrollador']; ?></p>
    <p id="game-release-date">Fecha de publicación: 
        <?php
